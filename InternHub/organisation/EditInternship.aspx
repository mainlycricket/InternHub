<%@ Page Title="Edit Internship" Language="C#" MasterPageFile="~/organisation/organisation.Master" AutoEventWireup="true" CodeBehind="EditInternship.aspx.cs" Inherits="InternHub.organisation.EditInternship" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2 style="text-align: center; margin: 3vh 0 3vh 0;">Edit Internship</h2>
    ...
    <table align="center">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <asp:Button ID="btnEditInternship" runat="server" Text="Update Internship" style="margin-bottom: 2vh;" Font-Size="Large" CssClass="btn btn-danger" OnClick="btnEditInternship_Click" />
                        </td>
                </tr>
